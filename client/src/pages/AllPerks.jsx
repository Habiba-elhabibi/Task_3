...
export default function AllPerks() {
  ...
  // 🧩 useEffect #1: Load all perks initially (on first render)
  useEffect(() => {
    loadAllPerks()
  }, [])

  // 🧩 useEffect #2: Auto-search when user types or changes merchant
  useEffect(() => {
    // Debounce: wait 500ms after typing before searching
  ...
  // 🧩 useEffect #3: Extract unique merchants from loaded perks
  useEffect(() => {
